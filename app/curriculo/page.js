export default function Curriculo() {
    return (
        <div className="flex flex-col items-center w-full pt-12 max-xl:pb-[80px]">
            ...
            <div className="max-sm:flex-col flex max-sm:text-sm sm:gap-20 xl:gap-28">
            ...
            <div className="flex flex-col mt-5 w-[80vw] md:w-[70vw] lg:w-[60vw] xl:w-[50vw]">
                ...
                <p className="text-white/70 max-sm:text-sm mb-4">Bacharelado em Sistemas de Informação
                ...
                <div className="flex max-sm:flex-col">
                    <div className="w-1/2">
                        ...
                        <ul className="text-white/70 max-sm:text-sm mb-4">
                            <li>TypeScript</li>
                            <li>JavaScript</li>
                            <li>ReactJS</li>
                            <li>Tailwind CSS</li>
